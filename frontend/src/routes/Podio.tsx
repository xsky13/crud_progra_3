                ...
                <div className="mt-5 flex flex-col justify-center items-center gap-y-3 w-full">
                    {
                        data.map((item, i) => {
                            if (i == 0) return;
                                ...
                                return (
                                    <div key={i} className="w-full sm:w-lg border-b border-muted/90 pl-0 pr-4 py-2 relative">
                                        {
                                            i == 1 ?
                                        ...
                                        <div className="mt-3">
                                            <div className="flex gap-1 items-center font-bold text-black dark:text-white">
                                                ...
                                                {Math.round(((item.promedioEstrellas + Number.EPSILON) * 10)) / 10}/5
                                            </div>
                                            <div className="text-xs text-muted-foreground">
                                                {item.cantidadCalificaciones} calificaciones
                                            </div>
                                        </div>
                                    </div>
                                )
